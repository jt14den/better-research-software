...
The lesson uses the [software repository with example code that **does not** follow good research software practices](https://github.com/carpentries-incubator/better-software-project)
